...
/* 78
স্টোর করেছি id যাতে কম ডাটা ইনফরমেশন করতে হয় । আবার, 
যেহেতু useState-এ  products আছে তাই id ধরে সেই product টা খুঁজে বের করে ফেলা যায় সহজে 
আমার মূল উদ্দেশ্য হচ্ছে এত বিশাল বড় একটা array কে 
 storage-এ set না করে শুধুমাত্র id টাকে সেট করা, যার মাধ্যমে  
 প্রথমে useState ব্যবহার করে পরতেক product এর details বের করা যায় 

*/

/*  90
 এখানে একটা বিষয় লক্ষণীয় যে এটা কিন্তু এই state-এর তৈরি array না,
 এটা আমার নিজের তৈরি করা array তাই সাধারণ নিয়মে push করতে পারতেছি 
 */

/* 43
এখানে পাঁচটা স্টেপ এর মধ্যে প্রথমটা হচ্ছে storedCart কে নিচ্ছি
দুই নাম্বারে product কে পাইতেছি 
তিন নাম্বারে quantity set করতেছি 
চার নাম্বারে savedCart এ রাখতেছি
পাঁচ নাম্বারে savedCart টা cart যে state আছে ওইখানে set করে দিতেছি 
*/